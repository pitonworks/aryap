...
export const projects: Project[] = [
  {
    ...
    description: {
      tr: 'Eskişehir\'in kalbinde AVM ve rezidansları bir araya getiren lüks yaşam projesi. Alışveriş ve konforun buluşma noktası.',
      en: 'A luxury living project combining a shopping mall and residences in the heart of Eskişehir. The meeting point of shopping and comfort.',
    },
    type: 'mixed',
    status: 'ongoing',
    location: { tr: 'Eskişehir', en: 'Eskişehir' },
    ...
    features: {
      tr: ['AVM entegrasyonu', 'Akıllı ev sistemleri', 'Kapalı otopark', 'Havuz & SPA', '7/24 güvenlik', 'Fitness merkezi'],
  ...
  },
  {
    ...
    description: {
      tr: 'Şehir merkezinde 80 üniteli, ailelere özel tasarlanmış modern konut projesi. Huzurlu ve konforlu bir yaşam alanı.',
    ...
    features: {
      tr: ['Aile odaklı tasarım', 'Çocuk oyun alanları', 'Yeşil alanlar', 'Kapalı otopark', 'Güvenlik kameraları', 'Jeneratör'],
  ...
  },
  {
    ...
    description: {
      tr: '7 işyeri ve 10 ofisten oluşan ticari proje. Modern iş dünyasının ihtiyaçlarına yönelik tasarlanmış prestijli bir iş merkezi.',
    ...
    features: {
      tr: ['Merkezi konum', 'Modern ofis tasarımı', 'Fiber internet altyapısı', 'Otopark', 'Asansör', 'Güvenlik'],
  ...
  },
  {
    ...
    description: {
      tr: 'Tepebaşı ilçesinde karma kullanım olarak geliştirilen prestijli proje. Konut ve ticari alanları bir arada sunuyor.',
      en: 'A prestigious mixed-use project developed in the Tepebaşı district. Offering residential and commercial spaces together.',
    },
    type: 'mixed',
    status: 'completed',
    location: { tr: 'Tepebaşı, Eskişehir', en: 'Tepebaşı, Eskişehir' },
    ...
    features: {
      tr: ['Karma kullanım', 'Merkezi konum', 'Otopark', 'Peyzaj alanları', 'Ticari üniteler', 'Sosyal tesisler'],
  ...
  },
  {
    ...
    description: {
      tr: '84 daire (3+1, 4+1) ve 14 ticari üniteden oluşan modern yaşam projesi. Ferah ve geniş yaşam alanları.',
    ...
    features: {
      tr: ['3+1 ve 4+1 seçenekleri', 'Ticari üniteler', 'Açık otopark', 'Çocuk oyun alanı', 'Yeşil alanlar', 'Güvenlik'],
  ...
  },
  {
    ...
    description: {
      tr: 'Bursa\'da 150 üniteli, akıllı ev sistemleriyle donatılmış modern konut projesi. Teknoloji ve konforu bir arada sunar.',
    ...
    features: {
      tr: ['Akıllı ev sistemleri', 'Kapalı otopark', 'Yüzme havuzu', 'Fitness', 'Çocuk oyun alanı', 'Peyzaj'],
  ...
  },
  {
    ...
    title: { tr: 'Aryap Çamlıca 144', en: 'Aryap Çamlıca 144' },
    description: {
      tr: 'Modern mimarisi ve zengin sosyal olanaklarıyla öne çıkan konut projesi. Huzurlu bir yaşam için ideal.',
    ...
    features: {
      tr: ['144 ünite', 'Sosyal tesisler', 'Otopark', 'Güvenlik', 'Peyzaj', 'Çocuk oyun alanı'],
  ...
  },
  {
    ...
    description: {
      tr: 'Gökmeydan\'da yerden ısıtmalı akıllı konut projesi. Modern teknoloji ve konforun buluşma noktası.',
      en: 'A smart residential project with underfloor heating in Gökmeydan. The meeting point of modern technology and comfort.',
    },
    type: 'residential',
    status: 'completed',
    location: { tr: 'Gökmeydan, Eskişehir', en: 'Gökmeydan, Eskişehir' },
    ...
    features: {
      tr: ['Yerden ısıtma', 'Akıllı ev', 'Otopark', 'Güvenlik', 'Jeneratör', 'Asansör'],
